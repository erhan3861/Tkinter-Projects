...
def getPath():
    global path # değiştirmek istiyorsak global yapmalıyız
...
open_button = Button(window, text = "Choose Folder", bg = "yellow", command = getPath, font = FONT)
open_button.place(x=200, y = 300)
label = Label(window, text = "No selected folder", bg = "cyan", font = FONT)
...
start_button = Button(window, text = "START", bg = "lime", command = start, font = FONT)
